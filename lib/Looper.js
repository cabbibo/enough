...
//    this.controller.addToUpdateArray( this._update.bind( this ) );
  ...
  Looper.prototype.end = function(){
    ...
    this.controller.removeFromUpdateArray( this._update.bind( this ) );
  ...
  Looper.prototype._onNewMeasure = function(){
    ...
    this.measure +=1;
    this.measureStartTime = (this.measure * this.measureLength) + this.ogStart;
